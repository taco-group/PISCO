...
def add_video_size_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--pisco_keep_ratio", type=float, default=1.0, help="Keep ratio for pisco.")
    return parser
...
def add_model_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--model_checkpoint_path", type=str, default=None, help="Paths to the saved load model checkpoints")
    parser.add_argument("--auto_load_checkpoints", default=False, action="store_true", help="auto load the most recent checkpoint")
    return parser
...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--loading_model", type=str, default=None, help="Loading model.")
