...
class AutoTorchModule(torch.nn.Module):
    ...
    def check_free_vram(self):
        device_type = self.computation_device_type if self.computation_device_type is not None else "cuda"
        gpu_mem_state = getattr(torch, device_type).mem_get_info(self.computation_device)
